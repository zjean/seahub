...
urlpatterns = patterns('',
   ...
   (r'^file_upload_progress_page/$', file_upload_progress_page),
    ...
    url(r'^pubinfo/departments/$', pub_departments, name='pub_departments'),
    url(r'^pubinfo/department/(?P<department_id>\d+)/info/$', pub_department_info, name='pub_department_info'),
    ...
    url(r'^sys/departmentadmin/$', sys_department_admin, name='sys_department_admin'),
    url(r'^sys/department/add/$', sys_department_add, name='sys_department_add'),
    url(r'^sys/department/(?P<department_id>\d+)/remove/$', sys_department_remove, name='sys_department_remove'),
    url(r'^department/(?P<department_id>\d+)/info/$', department_info, name='department_info'),
    url(r'^department/(?P<department_id>\d+)/user/add/$', department_user_add, name='department_user_add'),
    url(r'^department/(?P<department_id>\d+)/user/(?P<user_name>[^/]+)/remove/$', department_user_remove, name='department_user_remove'),
    url(r'^department/(?P<department_id>\d+)/grp/add$', department_grp_add, name='department_grp_add'),
    url(r'^department/(?P<department_id>\d+)/grp/(?P<group_id>[^/]+)/remove/$', department_grp_remove, name='department_grp_remove'),
